...
function updateMapImage() {     
    ...
    var imageName = "images/usaCarta_" + (livello) + ".png";
...
window.onload = async function() {
    ...
    .then(data => {
        ...
        data.playableLevels.forEach((level,index) => {
            ...
            if (button && level.levelnation == "usa") {
        ...
        // Filtra l'array per includere solo gli elementi con levelnation pari a 'usa'
        const worldLevels = data.playableLevels.filter(level => level.levelnation === 'usa');
        ...
        // Ora highestUsaLevel è l'elemento con il levelnumber più alto e levelnation pari a 'usa'
        // Puoi utilizzare highestUsaLevel nel tuo codice
