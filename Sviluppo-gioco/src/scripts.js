...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('saveConfigButton').addEventListener('click', saveThinButtonConfig);
    
    // Aggiungi un ascoltatore di eventi al pulsante carica
    document.getElementById('loadConfigButton').addEventListener('click', loadThinButtonConfig);
});
